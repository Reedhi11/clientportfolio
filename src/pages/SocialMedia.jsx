...
import socialBg from "../assets/socialmedia/3 social media.jpg";
import SocialGallery from "../components/projects/social/SocialGallery";
  ...
  return (
    <MainLayout>
      <main className="relative min-h-screen bg-[#FFF9F5] pt-[110px] pb-12">
        {/* Hero Section */}
        <section className="relative h-[30vh] min-h-[250px] w-full flex items-center justify-center overflow-hidden">
          {/* Background Image */}
          <div 
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-black/60 via-black/30 to-[#FFF9F5] z-0" />
          ...
          >
            <h1 className="text-5xl md:text-7xl font-black text-white mb-6 tracking-tight drop-shadow-lg">
              Social Media <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#FF4D8D] to-[#FF9F43]">Campaigns</span>
            </h1>
            <p className="text-lg md:text-xl text-white/90 max-w-2xl mx-auto font-medium drop-shadow">
              A vibrant collection of digital campaigns, visual storytelling, and brand engagement designed to captivate audiences.
            </p>
          </motion.div>
        </section>
