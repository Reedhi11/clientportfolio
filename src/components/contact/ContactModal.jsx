...
import letsTalkEmoji from "../../assets/letstalkemoji.jpeg";
const ChatIcon = () => (
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    >
                      <div className="relative rounded-2xl p-[2px] bg-gradient-funky shadow-glow">
                        <div className="rounded-[14px] h-16 w-16 sm:h-20 sm:w-20 flex items-center justify-center bg-gradient-funky text-white overflow-hidden">
                          <img src={letsTalkEmoji} alt="Let's Talk Emoji" className="w-full h-full object-cover" />
                        </div>
                      </div>
                      {/* online indicator */}
